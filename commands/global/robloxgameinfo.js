    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setAuthor({
          ...
          iconURL: 'https://i.imgur.com/Y5egr1d.png', // Roblox logo transparent PNG from Imgur
          url: `https://www.roblox.com/games/${game.rootPlaceId || universeId}` // optional link to game page
        })
